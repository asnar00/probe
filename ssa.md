...
v: u8 = latest s
x: u8 = peek s, i                             ; the i-th unread item, the reader not moved
s2: u8$ = advance(s, i)                       ; the reader moved on i
