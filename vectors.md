...
(Step 1 landed on 2026-08-27 as `TxN` — `f32x4`, `floatx4`, `intxN` — lane-by-lane by definition, on every backend; see ssa.md *Vectors*. The register class and the platform rules are the next step.)
